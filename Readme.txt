...
The plugin will also collet different inline scripts to one place. Thus making the source code
look better. 

To check, if the plugin is doing anything or not, compare the Head section before and after 
activating the plugin. After installation, you will see the HTML comment: &lt;!-- Order style js plugin --&gt; in head section.
